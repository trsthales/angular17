...
import { TokenExpiryComponent } from './core/token-expiry.component';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, RouterLink, CommonModule, UserIdModalComponent, ToastsComponent, DevTokenComponent, TokenExpiryComponent],
